...
function GlobalNav({ theme, onSetTheme, accent, onSetAccent, profileName, profileIconId, profileBg, profileIColor, onShowProfile, soundEnabled, onToggleSound, hapticEnabled, onToggleHaptic, soundPack, onSetSoundPack, onShowHistory, currentScreen }) {
  ...
  const hoverOn  = e => e.currentTarget.style.background = T.mode==="light" ? "rgba(0,0,0,0.06)" : "rgba(255,255,255,0.08)";
          ...
          {section === null && (
            <>
              <button
                ...
                onMouseEnter={currentScreen === "timer" ? undefined : hoverOn}
                onMouseLeave={currentScreen === "timer" ? undefined : hoverOff}>
                ...
                return (
                  <Fragment key={key}>
                    <button onClick={() => onSetSoundPack(key)} style={{
                      ...
                      onMouseEnter={e => e.currentTarget.style.background = active ? T.accent+"20" : T.mode==="light" ? "rgba(0,0,0,0.06)" : "rgba(255,255,255,0.08)"}
                      onMouseLeave={e => e.currentTarget.style.background = active ? T.accent+"15" : "transparent"}>
                ...
                return (
                  <Fragment key={key}>
                    <button onClick={() => onSetAccent(key)} style={{
                      ...
                      onMouseEnter={e => e.currentTarget.style.background = active ? scheme.swatch+"20" : T.mode==="light" ? "rgba(0,0,0,0.06)" : "rgba(255,255,255,0.08)"}
                      onMouseLeave={e => e.currentTarget.style.background = active ? scheme.swatch+"15" : "transparent"}>
                      <span style={{ display:"flex", alignItems:"center", gap:"0.75rem" }}>
                        <span style={{ width:"18px", height:"18px", borderRadius:"50%",
